...
func _install_skill_tree() -> void:
	_top_zone.visible = false
	_bottom_zone.visible = false
	...
	_tree_view.offset_left = 0.0
	_tree_view.offset_top = 0.0
	_tree_view.offset_right = 0.0
	_tree_view.offset_bottom = 0.0
